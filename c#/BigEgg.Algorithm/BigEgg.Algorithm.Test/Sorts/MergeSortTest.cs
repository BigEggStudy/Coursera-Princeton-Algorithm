...
namespace BigEgg.Algorithm.Test.Sorts
{
    ...
    public class MergeSortTest
    {
        ...
        {
            MergeSort.Sort(null, SortOrder.ASC);
        }
        ...
        {
            MergeSort.Sort(null, SortOrder.DESC);
        }
        ...
        {
            MergeSort.Sort(null, Point.X_ORDER);
        }
        ...
        {
            MergeSort.Sort(null, Point.X_ORDER, SortOrder.ASC);
        }
        ...
        public void SortWithComparerTest_ASCOrder_NullComparer()
        {
            ...
            MergeSort.Sort(points, null, SortOrder.ASC);
        }
        ...
        {
            MergeSort.Sort(null, Point.X_ORDER, SortOrder.DESC);
        }
        ...
        public void SortWithComparerTest_DESCOrder_NullComparer()
        {
            ...
            MergeSort.Sort(points, null, SortOrder.DESC);
        }
        ...
        public void SortTest_ASC()
        {
            ...
            MergeSort.Sort(a, SortOrder.ASC);
        ...
        public void SortWithComparerTest()
        {
            ...
            MergeSort.Sort(points, Point.X_ORDER);
        ...
        public void SortWithComparerTest_ASC()
        {
            ...
            MergeSort.Sort(points, Point.X_ORDER, SortOrder.ASC);
